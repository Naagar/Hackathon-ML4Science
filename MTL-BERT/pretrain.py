...
from dataset_qm9_download import download_and_extract_qm9
...
# big_dataset = download_and_extract_qm9(path) # pretrain_data

full_dataset = Smiles_Bert_Dataset('dataset_train2.csv',Smiles_head=args.Smiles_head) # train-data
